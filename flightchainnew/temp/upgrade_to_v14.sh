...
#Query on chaincode on Peer0/Britishairways
echo "Querying chaincode on britishairways/peer0..."
chaincodeQuery 0 1 90

sleep $DELAY

#Invoke on chaincode on Peer0/Britishairways
echo "Sending invoke transaction on britishairways/peer0..."
