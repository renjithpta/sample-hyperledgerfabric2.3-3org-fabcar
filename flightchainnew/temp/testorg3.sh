...
# Invoke chaincode on peer0.britishairways, peer0.gatewick, and peer0.org3
echo "Sending invoke transaction on peer0.britishairways peer0.gatewick peer0.org3..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.org3, peer0.gatewick, peer0.britishairways check if the result is 80
