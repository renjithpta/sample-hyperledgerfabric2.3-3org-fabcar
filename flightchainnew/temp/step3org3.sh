...
# on peer0.britishairways and peer0.gatewick, and uprage the chaincode on the
...
echo "===================== Installing chaincode 2.0 on peer0.britishairways ===================== "
installChaincode 0 1 2.0
echo "===================== Installing chaincode 2.0 on peer0.gatewick ===================== "
installChaincode 0 2 2.0

echo "===================== Upgrading chaincode on peer0.britishairways ===================== "
