...
var FlightChain = /** @class */ (function (_super) {
    ...
    FlightChain.prototype.getOperatingAirlineDataByIataCode = function (stubHelper, args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FlightChain.prototype.getAllDataCode = function (stubHelper, args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, stubHelper.getQueryResultAsList({
    ...
    FlightChain.prototype.getResultByQuery = function (stubHelper, args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, stubHelper.getQueryResultAsList(args)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
