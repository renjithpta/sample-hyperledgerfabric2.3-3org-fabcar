...
ORG_1_KEYSTORE=$(ls ../../first-network/crypto-config/peerOrganizations/birtishairways.ibs.aero/users/Admin\@birtishairways.ibs.aero/msp/keystore/)
ORG_2_KEYSTORE=$(ls ../../first-network/crypto-config/peerOrganizations/gatewick.ibs.aero/users/Admin\@gatewick.ibs.aero/msp/keystore/)
